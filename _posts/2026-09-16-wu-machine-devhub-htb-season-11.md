---
layout: post
title: "wu machine devhub htb season 11"
...
![Pasted image 20260802101232.png](/assets/img/writeups/Pasted image 20260802101232.png)
...
![Pasted image 20260802101904.png](/assets/img/writeups/Pasted image 20260802101904.png)
...
![Pasted image 20260802102933.png](/assets/img/writeups/Pasted image 20260802102933.png)

on a un serveur MCP sur le port 6274 accessible depuis internet 
une fois accéder on a : 

![Pasted image 20260802102227.png](/assets/img/writeups/Pasted image 20260802102227.png)

on essai de voir si la version  du service lancer à une version susceptible d’être exploiter en surface d'attaque 

![Pasted image 20260802102454.png](/assets/img/writeups/Pasted image 20260802102454.png)

on est sur la version 1.4.2 

![Pasted image 20260802103946.png](/assets/img/writeups/Pasted image 20260802103946.png)
...
![Pasted image 20260802104041.png](/assets/img/writeups/Pasted image 20260802104041.png)
...
![Pasted image 20260802110913.png](/assets/img/writeups/Pasted image 20260802110913.png) 
état du listenner 
![Pasted image 20260802110944.png](/assets/img/writeups/Pasted image 20260802110944.png) 
on a un shell  
...
![Pasted image 20260802113349.png](/assets/img/writeups/Pasted image 20260802113349.png)
...
![Pasted image 20260802121129.png](/assets/img/writeups/Pasted image 20260802121129.png)
...
![Pasted image 20260802130546.png](/assets/img/writeups/Pasted image 20260802130546.png)
...
![Pasted image 20260802134006.png](/assets/img/writeups/Pasted image 20260802134006.png)
...
![Pasted image 20260802134809.png](/assets/img/writeups/Pasted image 20260802134809.png)
...
![Pasted image 20260802135829.png](/assets/img/writeups/Pasted image 20260802135829.png)

on a le shell on le stabilise avec la méthode vu précédemment  une fois stabiliser on recherche le flag 

![Pasted image 20260802140226.png](/assets/img/writeups/Pasted image 20260802140226.png)

on a le flag user ici dans le user.txt
![Pasted image 20260802142840.png](/assets/img/writeups/Pasted image 20260802142840.png)

en listant tout un fichier m'intrigue : .opsmcp_key 
![Pasted image 20260802143939.png](/assets/img/writeups/Pasted image 20260802143939.png)
...
![Pasted image 20260802141857.png](/assets/img/writeups/Pasted image 20260802141857.png)
...
![Pasted image 20260802142258.png](/assets/img/writeups/Pasted image 20260802142258.png) 
...
![Pasted image 20260802143838.png](/assets/img/writeups/Pasted image 20260802143838.png)
on a  déja la clé API 
![Pasted image 20260802144018.png](/assets/img/writeups/Pasted image 20260802144018.png)
on voit que la clé API valide et le fichier intriguant sont les mêmes

on a aussi l'endpint du serveur ici 
![Pasted image 20260802144842.png](/assets/img/writeups/Pasted image 20260802144842.png)
en le testant on a : 
![Pasted image 20260802144916.png](/assets/img/writeups/Pasted image 20260802144916.png)

ave le Token on a 

![Pasted image 20260802145907.png](/assets/img/writeups/Pasted image 20260802145907.png)


sur la repose du serveur on a pas toutes les outils qu'on peut appeler 
dans server.py on ceci : 

![Pasted image 20260802150938.png](/assets/img/writeups/Pasted image 20260802150938.png)

ici le but est déclencher cette partie du code 

![Pasted image 20260802151116.png](/assets/img/writeups/Pasted image 20260802151116.png)

parce que l'accès en ssh root avec le mot de passe $6$rounds=656000$saltsalt$hashedpassword n' est pa possible 
![Pasted image 20260802151553.png](/assets/img/writeups/Pasted image 20260802151553.png)
...
![Pasted image 20260802153928.png](/assets/img/writeups/Pasted image 20260802153928.png)
...
![Pasted image 20260802154548.png](/assets/img/writeups/Pasted image 20260802154548.png)
...
![Pasted image 20260802154714.png](/assets/img/writeups/Pasted image 20260802154714.png)
on a bien  l'accès root  
![Pasted image 20260802154814.png](/assets/img/writeups/Pasted image 20260802154814.png)
