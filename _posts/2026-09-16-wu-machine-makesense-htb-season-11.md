---
layout: post
title: "wu machine makesense htb season 11"
...
![Pasted image 20260809092917.png](/assets/img/writeups/Pasted image 20260809092917.png) 
on commence la reconaissance avec le classique nmap
![Pasted image 20260809093124.png](/assets/img/writeups/Pasted image 20260809093124.png)
...
![Pasted image 20260809094828.png](/assets/img/writeups/Pasted image 20260809094828.png)

on va utiliser un moteur de recherche de vulnérabilités au niveau des applications web 
```bash
nuclei -u $ip 
```
![Pasted image 20260809095103.png](/assets/img/writeups/Pasted image 20260809095103.png)
